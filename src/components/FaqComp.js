      ...
      <Container>
        <Row className='mb-5'>
          <Col>
            ...
            <p className='text-center' data-aos="fade-up" data-aos-delay="200">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae.</p>
          </Col>
        </Row>
        <Row className='row-cols-lg-2 row-cols-1 g-4'>
          ...
          <Col className=''data-aos="fade-up" data-aos-delay="800">
            <Accordion>
              <Accordion.Item eventKey="0">
          ...
          <Col className=''data-aos="fade-up" data-aos-delay="1000">
            <Accordion>
              <Accordion.Item eventKey="0">
